    ...
    <div id="container">
        ...
        <div id="contents">
			...
			<div class="mem_con" style="width:100%; border:0;">
                ...
                <div class="m1">
					<a href="#" class="btn-gray-bold wh" onclick="Search(); return false;">조회</a>
					</div>
			...
			<div class="com_table_board" style="padding-top:50px;">
				...
				<div class="com_table_board-table" style="overflow:visible; margin-top: 10px;">
					<table style="table-layout:fixed;" cellspacing="1" cellpadding="1" summary="결과 테이블" >
						...
						<tbody>
							...
							<tr class="ed_bg">
                                ...
                                <td onclick="">승인완료</td>
                                <td onclick=""><a href="/surveyStats.html" class="btn-pop" onclick=" ">설문통계</a></td>
					...
					<div class="pack_btnn2">
                        ...
                        <a href="#" class="btn-gray-bold" onclick="goPage('surveyInsert.jsp'); return false;">등록</a>
                    </div>
				</div>
			</div>
